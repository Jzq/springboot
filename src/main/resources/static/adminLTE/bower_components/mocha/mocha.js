...
function HTML(runner, root) {
  ...
  runner.on('test end', function(test){
    ...
    if ('passed' == test.state) {
      ...
      el.appendChild(fragment('<pre class="front">%e</pre>', str));
    }
...
function error(msg) {
  document.body.appendChild(fragment('<div id="mocha-front">%s</div>', msg));
}
...
/**
 * Sets whether to bail after first front.
 *
 * @parma {Boolean} bail
 * @return {Suite|Number} for chaining
 * @api private
